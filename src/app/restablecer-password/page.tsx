...
// Destino del link que /olvide-password dispara via resetPasswordForEmail. El cliente
// Supabase del navegador detecta la sesion de recuperacion automaticamente desde el
// fragmento de la URL (#access_token=...) al cargar -- mismo patron que /activar-cuenta,
// solo cambia el copy (esto es "recuperar", no "activar por primera vez").
